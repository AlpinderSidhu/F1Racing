...
from pyspark.sql.functions import sum, row_number, count, when, col

filtered_df = race_result_df.groupBy(
    "race_year",
    "driver_name",
    "driver_nationality",
    "constructor_name",
...
final_df = filtered_df.withColumn("rank", rank().over(window))
